...
<body>
	...
	<aside id="sidebar" class="column">
		...
		<h3>Clients</h3>
		<ul class="toggle">
			<li class="icn_view_users"><a href="javascript:;" onClick="viewPatients();">View Clients</a></li>
		</ul>
		<h3>New Cars</h3>
		<ul class="toggle">
			<li class="icn_add_user"><a href="javascript:;" onClick="addOldPatient();">Add New Car</a></li>
			<li class="icn_view_users"><a href="javascript:;" onClick="viewOldPatients();">View New Cars</a></li>
		</ul>
		<h3>Used Cars</h3>
		<ul class="toggle">
			<li class="icn_add_user"><a href="javascript:;" onClick="addNewDoctor();">Add Used Car</a></li>
			<li class="icn_view_users"><a href="javascript:;" onClick="viewDoctors();">View Used Cars</a></li>
		</ul>
		...
		<footer>
			<hr/>
			<p><strong>&copy; 2017 Car-Point Automotive Management</strong></p>
			<p></p>
		</footer>

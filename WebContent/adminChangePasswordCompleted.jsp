...
<jsp:useBean id="patient" class="root.beans.AdminChangePasswordCompletedBean"/>
<jsp:setProperty name="patient" property="password" value="${param.password}"/>
<jsp:setProperty name="patient" property="username" value="${sessionScope.adminUsername}"/>
<%
if(patient.updateAdminPassword())

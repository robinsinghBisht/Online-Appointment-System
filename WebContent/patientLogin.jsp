...
<body>
	...
	<div id="container">
		...
		<form method="post" action="patientLoginSuccess.jsp" target="_parent">
		...
		<span style="color:red; font-size:11px">${param.SignupErrorMsg}</span>
		<span style="color:green; font-size:11px">${param.logoutSuccessMsg}</span>
		<span style="color:green; font-size:11px">${param.SignupSuccessMsg}</span>
	</div>

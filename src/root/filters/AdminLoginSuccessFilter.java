...
public class AdminLoginSuccessFilter implements Filter {
	FilterConfig config;
				...
				try {
					...
					if (rs.next()) {
						...
						RequestDispatcher rd = req
								.getRequestDispatcher("/___adminLogin___.jsp?loginErrorMsg=" + loginErrorMsg);
						rd.forward(req, res);
					}
				} catch (SQLException e) {
					System.out.println(e);
					req.getRequestDispatcher("/___adminLogin___.jsp").forward(req, res);
				}
